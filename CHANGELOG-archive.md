...
Older release history for DeepLore Enhanced. For the current and recent releases (2.5.x, 2.0.x), see **[CHANGELOG.md](CHANGELOG.md)**.

This archive covers `1.0.0-beta` and all pre-1.0 `ALPHA` releases, oldest at the bottom.
