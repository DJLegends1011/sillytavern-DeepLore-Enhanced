...
>
> **v2.5 migration reconciliation (2026-06-24):** Current implementation guidance is DeepLore on v2.5 `origin/staging` baseline `e63679f306276809f03f3935d51a2de57bbc19dd`. Runtime data should come from the current-chat `VerdictStore`; Obsidian actions should launch through `openObsidianUri`; and new mobile copy should be added as canonical English keys only, with non-English locale translation owned by the maintainer.
...
Desktop has a full popup graph visualization. Obsidian has a working mobile graph view that DeepLore recreates.
